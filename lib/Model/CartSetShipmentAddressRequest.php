...
/**
 * CartSetShipmentAddressRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartSetShipmentAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartSetShipmentAddressRequest';
    ...
    protected static $openAPITypes = [
        'tenant_id' => 'string',
        'cart_id' => 'string',
        'address' => '\OpenAPI\Client\Model\CartPostalAddress'
    ];
    ...
    */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\CartPostalAddress|null $address address
     *
     * @return self
     */
