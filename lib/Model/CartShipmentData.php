...
/**
 * CartShipmentData Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Cart
 * @author   OpenAPI Generator team
 ...
 */
class CartShipmentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartShipmentData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('shipment_grn', $data ?? [], null);
        $this->setIfExists('payload', $data ?? [], null);
        $this->setIfExists('cart_item_ids', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getShipmentGrn()
    {
        return $this->container['shipment_grn'];
    }

    /**
     * Sets shipment_grn
     *
     * @param string|null $shipment_grn shipment_grn
     *
     * @return self
     */
    public function setShipmentGrn($shipment_grn)
    {
        if (is_null($shipment_grn)) {
            throw new \InvalidArgumentException('non-nullable shipment_grn cannot be null');
        }
        $this->container['shipment_grn'] = $shipment_grn;
    ...
    {
        if (is_null($cart_item_ids)) {
            throw new \InvalidArgumentException('non-nullable cart_item_ids cannot be null');
        }
