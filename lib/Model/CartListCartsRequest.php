...
/**
 * CartListCartsRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Cart
 * @author   OpenAPI Generator team
 ...
 */
class CartListCartsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartListCartsRequest';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'page_token' => 'string',
        'sorts' => '\GeminiCommerce\Cart\Model\ListCartsRequestSort[]',
        'filter_mask' => 'string',
        'filter' => '\GeminiCommerce\Cart\Model\ListCartsRequestFilter'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('filter_mask', $data ?? [], null);
    ...
    */
     ...
     * Gets sorts
     *
     * @return \GeminiCommerce\Cart\Model\ListCartsRequestSort[]|null
     */
     ...
     * Sets sorts
     *
     * @param \GeminiCommerce\Cart\Model\ListCartsRequestSort[]|null $sorts sorts
     *
     * @return self
     */
    ...
    {
        return $this->container['filter_mask'];
    }

    /**
     * Sets filter_mask
     *
     * @param string|null $filter_mask filter_mask
     *
     * @return self
     */
    public function setFilterMask($filter_mask)
    {
        if (is_null($filter_mask)) {
            throw new \InvalidArgumentException('non-nullable filter_mask cannot be null');
        }
        $this->container['filter_mask'] = $filter_mask;
     ...
     * Gets filter
     *
     * @return \GeminiCommerce\Cart\Model\ListCartsRequestFilter|null
     */
     ...
     * Sets filter
     *
     * @param \GeminiCommerce\Cart\Model\ListCartsRequestFilter|null $filter filter
     *
     * @return self
     */
