...
/**
 * CartTriggerRealignmentResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartTriggerRealignmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartTriggerRealignmentResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cart_updated', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getCartUpdated()
    {
        return $this->container['cart_updated'];
    }

    /**
     * Sets cart_updated
     *
     * @param bool|null $cart_updated cart_updated
     *
     * @return self
     */
    public function setCartUpdated($cart_updated)
    {
        if (is_null($cart_updated)) {
            throw new \InvalidArgumentException('non-nullable cart_updated cannot be null');
        }
        $this->container['cart_updated'] = $cart_updated;
