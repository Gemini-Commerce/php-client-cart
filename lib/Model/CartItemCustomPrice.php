...
/**
 * CartItemCustomPrice Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Cart
 * @author   OpenAPI Generator team
 ...
 */
class CartItemCustomPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartItemCustomPrice';
    ...
    protected static $openAPITypes = [
        ...
        'previous_price' => '\GeminiCommerce\Cart\Model\CartMoney'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('previous_price', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets previous_price
     *
     * @param \GeminiCommerce\Cart\Model\CartMoney|null $previous_price previous_price
     *
     * @return self
     */
    public function setPreviousPrice($previous_price)
    {
        if (is_null($previous_price)) {
            throw new \InvalidArgumentException('non-nullable previous_price cannot be null');
        }
