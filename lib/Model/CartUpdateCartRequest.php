...
/**
 * CartUpdateCartRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Cart
 * @author   OpenAPI Generator team
 ...
 */
class CartUpdateCartRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartUpdateCartRequest';
    ...
    protected static $openAPITypes = [
        'tenant_id' => 'string',
        'cart_id' => 'string',
        'payload' => '\GeminiCommerce\Cart\Model\UpdateCartRequestPayload',
        'payload_mask' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payload_mask', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets payload
     *
     * @return \GeminiCommerce\Cart\Model\UpdateCartRequestPayload|null
     */
     ...
     * Sets payload
     *
     * @param \GeminiCommerce\Cart\Model\UpdateCartRequestPayload|null $payload payload
     *
     * @return self
     */
    ...
    {
        return $this->container['payload_mask'];
    }
     ...
     * @return self
     */
    public function setPayloadMask($payload_mask)
    {
        if (is_null($payload_mask)) {
            throw new \InvalidArgumentException('non-nullable payload_mask cannot be null');
        }
        $this->container['payload_mask'] = $payload_mask;
