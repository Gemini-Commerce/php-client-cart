 ...
 */
class CartMoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cartMoney';
    ...
    */
     ...
     * Sets units
     *
     * @param string|null $units The whole units of the amount. For example if `currencyCode` is `\"USD\"`, then 1 unit is one US dollar.
     *
     * @return self
     */
