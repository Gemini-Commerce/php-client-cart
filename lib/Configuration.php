...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://cart.api.gogemini.io';
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\Cart) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://cart.api.gogemini.io",
