...
class PromotionsApi
{
     ...
     * Apply Coupons
     *
     * @param  \OpenAPI\Client\Model\CartApplyCouponsRequest $body body (required)
     ...
     * Apply Coupons
     *
     * @param  \OpenAPI\Client\Model\CartApplyCouponsRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['applyCoupons'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Remove Coupons
     *
     * @param  \OpenAPI\Client\Model\CartRemoveCouponsRequest $body body (required)
     ...
     * Remove Coupons
     *
     * @param  \OpenAPI\Client\Model\CartRemoveCouponsRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeCoupons'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
